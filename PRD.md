...
- 图书封面样式需区别于普通卡片，保持封面感；封面上的“> 点击展开”入口文案保持不变，使用从书本右侧伸出的立体书签按钮效果，放置在图书内部靠右侧并略向下，桌面端按钮主体需要适当伸出封面右边缘；按钮主体保持紧凑矩形小圆角，右下方用 CSS border 三角形做出折角阴影，三角折角需与书本右边缘相连，底色为浅蓝白半透明渐变，投影保持轻量，整体仍匹配页面蓝白科技风格。
...
- AI Cookbook 图书封面内的“> 点击展开”按钮需位于书本中部位置，文案保持不变，桌面端需适当伸出书本右边缘，移动端也保持中部位置；使用轻量立体书签式效果、浅蓝白半透明底、与书本边缘相连的右下 border 三角折角和低强度投影，不能遮挡封面标题和底部信息。
